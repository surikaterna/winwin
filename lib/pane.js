...
module.directive('pane', function () {
      return {
		...
		template: '<div id="{{id}}" ng-class="{active: active}" ui-draggable ui-drag-format="application/x-lx-window-pane" ui-drag-data=\'{\"id\":\"{{id}}\"}\' ng-click="select()"><span pane-caption-transclude>{{caption}}</span></div>',
